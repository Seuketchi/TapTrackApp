...
mixin _$Attendance {
 ...
 String? get id; String get uid; String get name; DateTime get timestamp; String get attendanceStatus; String get registrationStatus;
...
@override
String toString() {
  return 'Attendance(id: $id, uid: $uid, name: $name, timestamp: $timestamp, attendanceStatus: $attendanceStatus, registrationStatus: $registrationStatus)';
}
...
@useResult
$Res call({
 String? id, String uid, String name, DateTime timestamp, String attendanceStatus, String registrationStatus
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  String uid,  String name,  DateTime timestamp,  String attendanceStatus,  String registrationStatus)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Attendance() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id,  String uid,  String name,  DateTime timestamp,  String attendanceStatus,  String registrationStatus)  $default,) {final _that = this;
switch (_that) {
case _Attendance():
return $default(_that.id,_that.uid,_that.name,_that.timestamp,_that.attendanceStatus,_that.registrationStatus);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? id,  String uid,  String name,  DateTime timestamp,  String attendanceStatus,  String registrationStatus)?  $default,) {final _that = this;
switch (_that) {
case _Attendance() when $default != null:
return $default(_that.id,_that.uid,_that.name,_that.timestamp,_that.attendanceStatus,_that.registrationStatus);case _:
  return null;
...
class _Attendance implements Attendance {
  const _Attendance({this.id, required this.uid, required this.name, required this.timestamp, required this.attendanceStatus, required this.registrationStatus});
